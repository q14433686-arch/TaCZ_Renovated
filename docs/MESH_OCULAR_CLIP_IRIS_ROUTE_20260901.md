...
本轮处理上一轮实机反馈的三个问题（问题即源自 2026-08-31/09-01 维护者实机反馈；
次日又收到第二批实机反馈「光影下二次渲染失效 + 镜内枪前端残影」，见下文「更正与后续」，
已修复）。文首齐平自查为当时快照；实机覆盖与未逐项补记的分项见发布公告「已核验 /
已知边界」与文末复验清单。
...
## 实机复验清单（写入时全部未验证；实机闭环见正文「更正与后续」，分项补记）
