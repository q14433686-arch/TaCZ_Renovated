...
| [`records/`](records/) | 开发者（查证用） | 各工作包的 API 证据 / 冒烟日志 / 决策记录，**冻结快照，不再更新** |

仓库根目录：[`README.md`](../README.md)（门面）、[`CHANGELOG.md`](../CHANGELOG.md)（版本历史）、
[`CHARTER.md`](../CHARTER.md)（工作合同）、[`LICENSES.md`](../LICENSES.md)（许可清单）。
