...
/**
 * LRTactical（LesRaisins Tactical Equipements）内置层 —— NeoForge 26.1.2（WP-LR2）。
 *
 * <h2>移植来源与授权</h2>
 * <ul>
 *   <li>原作：{@code LesRaisins-Studios/LesRaisins-Tactical-Equipements}
 *       —— Programmer {@code xjqsh}，Artist {@code LeComte}，代码 GPL-3.0；</li>
 *   <li>语义权威：refab（TaCZ_Refabricated_Unofficial）{@code 26.1.2} 分支的
 *       {@code me.xjqsh.lrtactical} 移植（Fabric）；本包按 WP-LR2 工单改写为
 *       NeoForge 习语。</li>
 * </ul>
 *
...
public final class EquipmentMod {
    ...
    public static void register(IEventBus modEventBus) {
        ...
        LOGGER.info("LRTactical built-in layer (WP-LR2, NeoForge 1.21.11) registered");
    }
