...
public final class PolyRenderPolicy {
    ...
    /**
     * 【开镜距离补偿 —— 同步自姊妹 01a05db2 线 e1aad106 / 26.2 线 {@code 0886909}
     * （其实机回报）】两道距离闸门都按<b>裸眼</b>距离调参，但开镜把远处物体的角尺寸放大了
     * Z 倍：4x 镜下 48 格的 poly 上限观感只剩 12 格、16 格全模豁免观感只剩 4 格 ——
     * 举镜看到的掉落物/第三人称 mesh 枪几乎必然是立方体。
     *
     ...
     *
     * <p><b>证据级别</b>：机制与实机现象 = 26.2 线；本仓这一份 = 同形移植，<b>实机未验</b>。</p>
     */
